...
import (
	...
	"github.com/drivehosinc/eld-shared/random"
...
func CreateHashFromPassword(password string, p *Params) (encodedHash string, err error) {
	salt, err := random.GenerateRandomBytes(p.saltLength)
	if err != nil {
		return "", err
	}
